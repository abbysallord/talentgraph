...
export const ReasoningScorerModule: React.FC<ReasoningScorerModuleProps> = ({
  ...
  const getScoreBadge = (score: number) => {
    ...
    if (score >= 70) return { color: 'text-emerald-800 bg-emerald-50 border-emerald-200', label: 'Qualified Candidate' };
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          ...
          <div className="flex items-center space-x-3 shrink-0 self-start md:self-auto">
            ...
            <button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-5 py-2.5 rounded-xl text-xs flex items-center space-x-2 transition-all shadow-md shadow-emerald-600/15 cursor-pointer"
            >
